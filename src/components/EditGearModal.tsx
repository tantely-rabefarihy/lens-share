...
export function EditGearModal({ gear, onClose, onSuccess }: EditGearModalProps) {
  const [formData, setFormData] = useState({
    name: gear.name,
    description: gear.description,
    category: gear.category,
    condition: gear.condition.charAt(0).toUpperCase() + gear.condition.slice(1),
    hourlyRate: gear.gear_pricing?.hourly_rate.toString() || '',
    dailyRate: gear.gear_pricing?.daily_rate.toString() || '',
  });
